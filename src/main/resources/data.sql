...
insert into ingredient values ('�pinard');
...
insert into ingredient values ('Noix de coco r�p�e');
insert into ingredient values ('Mangue');
insert into ingredient values ('Fromage de ch�vre');
...
insert into ingredient values ('Cacahu�tes');
insert into ingredient values ('Cannelle');
insert into ingredient values ('Cacao en poudre');
insert into ingredient values ('Mangue s�ch�e');
...
insert into ingredient values ('M�res');
insert into ingredient values ('Viande de b�uf');
...
insert into ingredient values ('Basilic sacr�');
...
insert into ingredient values ('�dam');
insert into ingredient values ('P�ches');
...
insert into ingredient values ('M�res blanches');
insert into ingredient values ('Asperges');
insert into ingredient values ('Yaourt � la vanille');
insert into ingredient values ('Piments jalape�os');
insert into ingredient values ('Huile d''olive');



--Insertion de 5 cocktails de type boisson
insert into product (name,type, price, enable) values ('Fizzy Mango Breeze','boisson',0,'true');
insert into product (name,type, price, enable) values ('Midnight Serenade',	'boisson',0,'true');
insert into product (name,type, price, enable) values ('Velvet Moonshine',	'boisson',0,'true');
insert into product (name,type, price, enable) values ('Citrus ZingaRita',	'boisson',0,'true');
insert into product (name,type, price, enable) values ('Berry Bliss Punch',	'boisson',0,'true');

--Insertion de 5 softs de type boisson
insert into product (name,type, price, enable) values ('Coca',		'boisson',0,'true');
insert into product (name,type, price, enable) values ('Limonade',	'boisson',0,'true');
insert into product (name,type, price, enable) values ('Diabolo',	'boisson',0,'true');
...
insert into product (name,type, price, enable) values ('Carpaccio di Pesce',	'entree',0,'true');	
insert into product (name,type, price, enable) values ('Arancini Siciliani',	'entree',0,'true');	
insert into product (name,type, price, enable) values ('Insalata Mista',		'entree',0,'true');
insert into product (name,type, price, enable) values ('Polenta Funghi',		'entree',0,'true');
insert into product (name,type, price, enable) values ('Prosciutto Dolce',		'entree',0,'true');
insert into product (name,type, price, enable) values ('Gnocchi al Ragu',		'entree',0,'true');
insert into product (name,type, price, enable) values ('Fritto Mare',			'entree',0,'true');
...
insert into product (name,type, price, enable) values ('Pizza Saumon Fum� Bianca',		'pizza',0,'true');
insert into product (name,type, price, enable) values ('Pizza Ch�vre Pesto',			'pizza',0,'true');
...
insert into product (name,type, price, enable) values ('Pizza Ratatouille Napoli',		'pizza',0,'true');
insert into product (name,type, price, enable) values ('Calzone Aperto Mare',			'pizza',0,'true');

--Insertion de 10 plats principal
insert into product (name,type, price, enable) values ('Escalopes Bolognaises',		'principal',0,'true');
insert into product (name,type, price, enable) values ('Poulet Proven�al',			'principal',0,'true');
insert into product (name,type, price, enable) values ('Lasagne Gratin�es',			'principal',0,'true');
...
insert into product (name,type, price, enable) values ('Ravioli � l''Estragon',		'principal',0,'true');
...
insert into product (name,type, price, enable) values ('Cr�me Br�l�e al Limone',		'desserts',0,'true');
...
insert into product (name,type, price, enable) values ('Cannoli � la Framboise',		'desserts',0,'true');
...
insert into product (name,type, price, enable) values ('Gelato � la Lavande',			'desserts',0,'true');
...
insert into _order (id, client_name, time_slot, table_number, paid, status) values (8,'Emmy Sph�re',		'20:15',	0,	'false','ready');
...
insert into _order (id, client_name, time_slot, table_number, paid, status) values (11,'Th�o Courant',		'20:40',	-1,	'true',	'waiting');
...
insert into _order (id, client_name, time_slot, table_number, paid, status) values (14,'�ve Anescense',		'21:30',	-1,	'true',	'waiting');
insert into _order (id, client_name, time_slot, table_number, paid, status) values (15,'Ycare Abine',		'21:40',	-1,	'true',	'waiting');
insert into _order (id, client_name, time_slot, table_number, paid, status) values (16,'Jerry Gol�',		'21:50',	7,	'false','waiting');
